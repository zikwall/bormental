...
Widget buildChannelItem(BuildContext context, Channel channel) {
      ...
      children: <Widget>[
        ...
        Column(
          ...
          children: <Widget>[
            ...
            _buildTimeline(
              width,
              current.currentProgramStop - current.currentProgramStart,
              now().toInt() - current.currentProgramStart,
            ),
            const SizedBox(height: 5),
...
Widget _buildTimeline(double width, int current, int total) {
  return Container(
