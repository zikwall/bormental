...
Future<bool> showBan(BuildContext context) async {
  // show the dialog
  return await showGeneralDialog(
    ...
    pageBuilder: (ctx, anim1, anim2) => _buildBanPopup(context),
...
Widget _buildBanPopup(BuildContext context) {
...
Future<bool> showUpdate(BuildContext context) async {
  ...
  return await showGeneralDialog(
    ...
    barrierColor: Colors.black38,
    transitionDuration: const Duration(milliseconds: 10),
    pageBuilder: (ctx, anim1, anim2) => _buildUpdatePopup(context),
    transitionBuilder: (ctx, anim1, anim2, child) => BackdropFilter(
      filter: ImageFilter.blur(
          sigmaX: 1 * anim1.value, sigmaY: 1 * anim1.value
      ),
...
Widget _buildUpdatePopup(BuildContext context) {
  return OrientationBuilder(
      builder: (context, orientation) {
        late double height;
        late double width;
